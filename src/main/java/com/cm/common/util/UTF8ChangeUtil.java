...
/**
 * @Project CM
 * @ClassName com.common.util.UTF8ChangeUtil
 * @Author 修峻青
 * @Time   2016-8-12-11:07
 * @Declear UTF8字符编码转换类
 * @Control 筹Mi-V1.0版权控制
 */
public class UTF8ChangeUtil extends AbstractHttpMessageConverter<String> {

    public static final Charset DEFAULT_CHARSET = Charset.forName("UTF-8");
    private final List<Charset> availableCharsets;

    public UTF8ChangeUtil() {
        this(DEFAULT_CHARSET);
    }

    public UTF8ChangeUtil(Charset defaultCharset) {
