...
public class VerifyCodeUtil extends HttpServlet{
     ...
     */
    public void initVerifyCord() throws ServletException {
        //验证码宽度
        String strWidth ="80";
        //验证码高度
        String strHeight ="30";
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        Font font = new Font("Tahoma", Font.BOLD, fontHeight);
        // 设置字体
        g.setFont(font);
        // 画边框
        ...
        // 将验证码保存到Session中，等待验证
        request.getSession().setAttribute( "validateCode",randomCode.toString() );
        System.out.println("验证码："+request.getSession().getAttribute( "validateCode" ));
        // 禁止图像缓存，防止通过缓存捕获验证码
